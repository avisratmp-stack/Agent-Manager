...
class OmagentHandler(BaseAgentHandler):
    """Request handler for Omagent."""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__(config or {})
        self.agent_name = "omagent"
    ...
    async def _execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        # TODO: Implement Omagent business logic
        raise NotImplementedError("OmagentHandler._execute")
