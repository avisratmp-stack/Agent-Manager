...
class ApmHandler(BaseAgentHandler):
    """Request handler for Apm Agent."""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__(config or {})
        self.agent_name = "apm-agent"
    ...
    async def _execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        # TODO: Implement Apm Agent business logic
        raise NotImplementedError("ApmHandler._execute")
