...
class TraceHandler(BaseAgentHandler):
    """Request handler for Trace Agent."""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__(config or {})
        self.agent_name = "trace-agent"
    ...
    async def _execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        # TODO: Implement Trace Agent business logic
        raise NotImplementedError("TraceHandler._execute")
